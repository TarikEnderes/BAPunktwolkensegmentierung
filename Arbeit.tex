...
\supervisor[m]{Prof. Dr. Vasileios Belagiannis} %use optional argument [f] for female label, default is [m] for male
\examiner{Prof. Dr. Vasileios Belagiannis}
...
% - - - - - - - - - - - - - - -
 \mainmatter                       %import chapters (tip: use one tex-file for each chapter)
   \input{doc/Einleitung.tex}
   \input{doc/Literatur.tex}
   \input{doc/Theorie.tex}
   \input{doc/Arbeitsmethodik_und_Entwicklung.tex}
   \input{doc/Datensaetze.tex}
   \input{doc/Experimente.tex}
   \input{doc/Zusammenfassung.tex}
% - - - - - - - - - - - - - - -
