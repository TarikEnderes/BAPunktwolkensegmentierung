	...
	\section{Backbones}
		...
		\subsection{Xecption}
			...
			\begin{figure}[h]
				...
				\caption{Schematische Darstellung des Prinzip von Depthwise Separable Convolution zur Tensorverarbeitung \cite{MobileNetV2}}
				\label{fig:SepConv}
			\end{figure}
