\chapter{Experimente}
	...
	\section{Verfeinerung mit KITTI}
		...
		\begin{figure}[h]
			...
			\caption{Graphische Darstellung der Ergebnisse von Tabelle \ref{res:mix}. Besonders auffällig sind die Unterschiede bei den Ergebnissen auf den KITTI-Daten (rot) und der Einbruch bei denen der Cityscapes-Bilder (blau) in Model C.}
			\label{fig:Verg}
		\end{figure} 
	...
	\section{Segmentierung von Punktwolken}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=15cm]{img/BspPWSeg1.png}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=15cm]{img/BspPWSeg2.png}
